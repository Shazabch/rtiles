...
final class SaleTable extends PowerGridComponent
{
    ...
    *
    * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\Sale>|null
    */
    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', function(Sale $model) { 
                return Carbon::parse($model->created_at)->format('d/m/Y H:i:s');
            })
            ->addColumn('updated_at_formatted', function(Sale $model) { 
...
;
    ...
    */
    ...
    {
       try {
           $updated = Sale::query()->findOrFail($data['id'])
                ->update([
