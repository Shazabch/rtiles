...
<html lang="en">
    ...
    <head> 
        ...
        <meta name="title" content="RS Energy">
    ...
    <body class="bg-light" 
        style="background-image:url(volt-theme/html&css/assets/img/illustrations/signin.jpg);
        ...
        <script src="{{asset('volt-theme/html&css/vendor/vanillajs-datepicker/dist/js/datepicker.min.js')}}"></script>
        <script src="{{('volt-theme/html&css/vendor/notyf/notyf.min.js')}}"></script>
